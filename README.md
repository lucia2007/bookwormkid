...
### Returning Visitor
  ...
  - A user can easily register, sign in and access majority of the features of the website.
  - Both a registered and unregistered user can make a purchase.
  - A signed in user can also see their past purchases and their wishlist.
  - A registered user can save their contact and billing information so they don't have to fill it in each time.
